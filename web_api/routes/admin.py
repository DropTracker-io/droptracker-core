...
SERVICE_REGISTRY: list[dict] = [
    ...
    {"unit": "droptracker-webapi", "name": "Web API (this backend)", "category": "Web & APIs",
     ...
     "kind": "service", "confirm_stop": True},
    {"unit": "droptracker-data-api", "name": "Data API v2 (external)", "category": "Web & APIs",
     "description": "Authenticated /v2 player+group data for third-party apps; isolated so heavy reads cannot block intake",
     "port": 31326, "kind": "service", "confirm_stop": True},
