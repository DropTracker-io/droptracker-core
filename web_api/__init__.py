...
from web_api.routes.sites import sites_bp
...
from web_api.routes.event_conquest import event_conquest_bp
...
from web_api.routes.group_always_list import group_always_list_bp
from web_api.routes.member_messages import member_messages_bp
...
def create_app() -> Quart:
    ...
    app.register_blueprint(sites_bp, url_prefix=API_PREFIX)
    ...
    app.register_blueprint(event_conquest_bp, url_prefix=API_PREFIX)
    ...
    app.register_blueprint(group_always_list_bp, url_prefix=API_PREFIX)
    app.register_blueprint(member_messages_bp, url_prefix=API_PREFIX)
    ...
    app.register_blueprint(platform_bp, url_prefix=API_PREFIX)
    ...
    app.register_blueprint(clan_log_bp, url_prefix=API_PREFIX)
    app.register_blueprint(player_state_bp, url_prefix=API_PREFIX)
