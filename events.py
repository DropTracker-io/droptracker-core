...
from db.models import ItemList, NpcList, Player, Session, Drop, CombatAchievementEntry, PersonalBestEntry, CollectionLogEntry
...
bot = interactions.Client(token=os.getenv("TEST_BOT_TOKEN"))
